...
<form class="mt-4 space-y-4 sm:mt-6 sm:space-y-6" wire:submit="register">
    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
        ...
        <div class="sm:col-span-2">
            <label for="email"
                   class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">{{ __('Email') }}</label>
            <input
                type="email"
                id="email"
                wire:model="email"
                class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-gray-900 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500 sm:text-sm @error('email') @enderror"
        ...
        <div>
            <label for="password"
                   class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">{{ __('Password') }}</label>
            <input
                type="password"
                id="password"
                wire:model="password"
                class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-gray-900 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500 sm:text-sm @error('password') @enderror"
                placeholder="••••••••"
                required
            />
            @error('password')
        ...
        <div>
            <label for="password_confirmation"
                   class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">{{ __('Confirm Password') }}</label>
            <input
                type="password"
    ...
    <div class="flex items-start">
        ...
        <label for="terms"
               class="mr-3 text-sm text-gray-500 dark:text-gray-300">{{ __('I agree to the terms and conditions') }}</label>
    </div>
    @error('terms')
    <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
    @enderror
