<x-livewire-modal::stack>
    <x-livewire-modal::slideover position="right">
        <div class="p-6 space-y-4">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('Add User') }}</h3>
            ...
            <div class="flex items-center justify-end gap-3">
                ...
                <button type="button" wire:click="save" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">{{ __('Save') }}</button>
            </div>
        </div>
