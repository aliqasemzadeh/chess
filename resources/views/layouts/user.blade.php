...
<body class="bg-gray-50 text-slate-800">
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="hidden md:block w-64 bg-white border-r border-slate-200">
            <div class="h-16 flex items-center px-4 font-semibold">User Area</div>
            <nav class="px-2 space-y-1">
                <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-100 text-slate-700">Home</a>
                <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-100 text-slate-700">Profile</a>
                <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-100 text-slate-700">My Settings</a>
            </nav>
        </aside>
